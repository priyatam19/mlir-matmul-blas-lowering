// Benchmark harness: bert_attn  (128x64) x (64x128) -> (128x128)
// RUNS=500
#include <algorithm>
#include <chrono>
#include <cstdint>
...
int main() {
  ...
  long long p50 = times[500/2];
  long long p10 = times[500/10];
  long long p90 = times[500*9/10];
  long long sum = 0; for (auto t:times) sum+=t;
  long long avg = sum/500;
